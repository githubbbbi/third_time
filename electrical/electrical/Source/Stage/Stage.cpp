	...
	int screenX, int screenY, int displaceX, int displaceY)
{
	...
	int mapChipLeft = (screenX - displaceX + (displaceX / (screenX / (WIN_WIDTH / 2))) - WIN_WIDTH / 2) / CHIP_SIZE - 2;
	int mapChipRight = (screenX - displaceX - (displaceX / (screenX / (WIN_WIDTH / 2))) + WIN_WIDTH / 2) / CHIP_SIZE + 2;
	int mapChipTop = (screenY - displaceY + (displaceY / (screenY / (WIN_HEIGHT / 2))) - WIN_HEIGHT / 2) / CHIP_SIZE - 2;
	int mapChipBottom = (screenY - displaceY - (displaceY / (screenY / (WIN_HEIGHT / 2))) + WIN_HEIGHT / 2) / CHIP_SIZE + 2;
